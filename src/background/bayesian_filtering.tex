...
Under these assumptions, the state's probability densities can be given with estimates of the mean and covariance.
...
With nonlinear state-space models, one use linear linear approximations to preserve the convenience of Gaussian densities.
