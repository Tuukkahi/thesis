...
Although the original Kalman filter offers a robust solution to optimal filtering problems, it fails to efficientl scale for large state and observation spaces.
