This subsection covers some basic principles of spatio-temporal data and dynamic modelling such data through the advection-diffusion equation. 
...
At the core of the model of this thesis is the advection equation describing the temporal transportation of data according to an advection field.
As a natural extension to the pure advective process, it is often also fruitful to consider also diffusion as an advection-diffusion process.
