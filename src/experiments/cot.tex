...
Satellite data often contain a considerable number of missing values and thus interpolating the missing pixel values was needed.
Given the computational cost of advanced interpolation, a simple nearest valid value approach was employed.
While this crude method results in interpolation artefacts, for the purposes of the model training this is not necessarily a problem. 
