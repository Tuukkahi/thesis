...
eb1 = plt.errorbar(time, np.nanmean(xprior_mean,axis=(1,2)), 2*xprior_std_mean, label='Prior', marker="s", linestyle="none", transform=trans1, color='black', fillstyle='none')
