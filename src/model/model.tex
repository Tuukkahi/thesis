...
The objective is to create a framework where possibly multiple partial observations could be used to generate probabilistic estimates of some quantity of interest that evolves according to the advective model.
...
\begin{itemize}
    ...
    \item
        An ensemble Kalman filter that leverages the neural network as a state evolution model in the state-space model to provide probabilistic state estimates.
\end{itemize}
