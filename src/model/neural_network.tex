The neural network model is devloped to predict advection fields from two-dimensional spatio-temporal data.
...
Assuming a square spatial domain $\R^{n \times n}$, the Vandermonde matrix for the two-dimensional second-degree polynomials can be constructed as
\begin{equation}
    ...
    \begin{bmatrix}
        ...
        1 & x_{n} & y_{n} & x_{n}^2 & x_{n}y_{n} & y_{n}^2
    \end{bmatrix}.
\end{equation}
